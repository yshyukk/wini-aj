...
<body>
   ...
   <script>
              ...
              success : function (list) {
                 ...
                 var html = "";
                  for (var i = 0; i < list.length; i++) {
                	  var listVar = $('input[name=mbr_type'+i+']:checked').val();
                     html+="<tr>";
                      html+="<td>"+list[i].mbr_sn+"</td>";
                      html+="<td>"+list[i].mbr_id+"</td>";
                      html+="<td>"+list[i].mbr_nm+"</td>";
                      html+="<td><input type='radio' value='0'class='radio' id='mbr_type_admin"+i+"' name='mbr_type"+i+"'>admin ";
                      html+="<input type='radio' value='1' class='radio' id='mbr_type_system"+i+"' name='mbr_type"+i+"'>시스템 관리자 ";
                      html+="<input type='radio' value='2' class='radio' id='mbr_type_general"+i+"' name='mbr_type"+i+"'>일반 사용자   ";
      ...
      /* 회원 권한 변경 */
      function mbrAuthority(mbr_sn, a){
    	  var listVar = $('input[name=mbr_type'+a+']:checked').val();
    	  console.log(mbr_sn, listVar);
